...
def parse_corpus_links(index_html: str, base_url: str) -> list:
...
def download_if_missing(doc_url: str, dest_dir: str) -> bool:
...
def sync_corpus_from_index(index_url: str, dest_dir: str) -> dict:
    """
